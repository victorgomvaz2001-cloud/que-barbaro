      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-8 md:px-16 lg:px-24">
        ...
        <div className="mt-16 flex flex-col sm:flex-row items-center justify-between gap-6" style={anim(visible, 900, mounted)}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-3 font-neue text-[13px] uppercase tracking-[0.28em] transition-all duration-300 px-6 py-4 border border-[navy] hover:border-[rgba(26,31,58,0.28)]"
            style={{ color: '#1a1f3a' }}
          >
