...
export default async function GoaPage() {
  ...
  const service = t.raw('goa') as ServiceData
  const seoRoute = locale === 'es' ? '/servicios/goa' : `/${locale}/servicios/goa`
  ...
  return (
    <>
      ...
      >
        <Image
          src="https://cavidas-que-barbaro.s3.eu-north-1.amazonaws.com/herogoaorganics.webp"
          alt="Goa Organics"
          fill
          priority
          className="object-cover object-center"
        />
        <div className="relative z-10 w-full max-w-[1680px] mx-auto px-6 md:px-12 pt-16 md:pt-24 text-center">
          <h1
            className="font-primary uppercase leading-[0.9]"
            style={{ fontSize: 'clamp(3.5rem, 8vw, 8rem)', color: '#1a1f3a' }}
          >
            Goa Organics
          </h1>
        </div>
